...
public class VillagerFarmGoal extends MoveToTargetPosGoal {
   ...
   public VillagerFarmGoal(SocialVillager villagerEntity_1, double double_1) {
   ...
   public void tick() {
      super.tick();
      this.owner.getLookControl().lookAt((double)this.targetPos.getX() + 0.5D, (double)(this.targetPos.getY() + 1), (double)this.targetPos.getZ() + 0.5D, 10.0F, (float)this.owner.getLookPitchSpeed());
      if (this.hasReached()) {
